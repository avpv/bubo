...
struct PomodoroDefaults: Equatable, Sendable {
    let work: Int
    let breakDur: Int
    let rounds: Int
    ...
    var cycleMinutes: Int { work + breakDur }
    ...
    /// a Pomodoro.
    static func suggested(for durationMinutes: Int) -> PomodoroDefaults {
        let work = 25
        let breakDur = 5
    ...
    /// hidden from the UI.
    static let minimumConvertibleMinutes: Int = 25
}
