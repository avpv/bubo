...
struct SyntheticPairGenerationResult: Sendable {
    let pairs: [PreferencePairEvent]
    let variantsSampled: Int
    let rejectedByNoise: Int
}

enum SyntheticPreferencePairGenerator {
