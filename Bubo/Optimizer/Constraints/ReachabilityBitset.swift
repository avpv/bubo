...
struct ReachabilityBitset: Sendable {
    ...
    /// translate freely.
    static func build(ids: [String], edges: [String: Set<String>]) -> ReachabilityBitset? {
    ...
    /// `CTZ` instruction.
    func forEachReachable(from: String, _ body: (String) -> Void) {
