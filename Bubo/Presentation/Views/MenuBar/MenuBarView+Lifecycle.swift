...
// MARK: - Auto Defer
//
// The day-rollover timer (kept on the screen model) and the once-per-day
// backlog deferral pass, both wired from `handleAppear` above. Grouped
// here because they are a single lifecycle concern.
