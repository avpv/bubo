...
> **Last ingest:** 2026-09-02 (rev: recovery made fully automatic — wake-from-sleep store rebuild + dead-push self-heal replace the short-lived Force Refresh button. Prior revs same day: split store roles / fresh read store; CalDAV server verification; manual hide tombstones)
