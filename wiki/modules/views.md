...
> **Last ingest:** 2026-05-23 (rev: PR #555 — removed nowMarker case from MenuBarDayListItem, updated line counts)
...
| `MenuBarDayListItem.swift` | `enum MenuBarDayListItem: Identifiable` (`:13`) | 25 | Row kind for the day list: event / free-slot / ghost |
