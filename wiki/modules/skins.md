...
> **Last ingest:** 2026-05-16 (rev: per-skin gravity-of-light. Apple-grammar stays unified, but each skin now has an *authored character*: a unique gradient direction (vertical / horizontal / diagonal / radial / clear), 3–4 colour stops with deliberate ramp progression, a meaningful secondary accent (palette companion, not just dimmed primary), and an authored `darkMoodMode` where the identity demands it (`light` for Sierra / Arctic / Rose Gold, `dark` for Midnight). Metaphors: Apple — store-light, Ocean — sky-to-deep-water, Sage — clear-to-earth rise, Sierra — dawn horizon, Graphite — steel polish, Luna Silver — ThinkPad chrome, Arctic — glacier ramp, Lavender — sunset rake, Luna Blue — Luna chrome, Midnight — studio spotlight, Rose Gold — sunrise glow, System — macOS-native, Classic — paper-flat, Luna Olive — Office 2003. No two skins share both direction *and* palette feel.)
