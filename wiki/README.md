...
This directory is an **LLM-maintained knowledge base** about the Bubo codebase. It is generated and kept current by AI agents working on the repo (Claude Code primarily). It is not a user manual — for product docs see [`../README.md`](../README.md).
