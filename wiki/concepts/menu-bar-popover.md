...
> **Last ingest:** 2026-06-10 (rev: PR #559 — removed stale NowNextLine from sub-views list)
...
- Sub-views: `DaySectionView`, `EventRowView`, `GhostEventRow` (optimizer ghost previews), `FreeSlotRow`, `SmartActionsBar`.
