...
> **Kind:** concept
> **Sources:** PRINCIPLES.md
> **Last ingest:** 2026-05-14 (rev: source restored in PR #565 as `PRINCIPLES.md` at repo root — §1–§10; body of this page predates that file and has not been fully reconciled with it)
> **Related:** [`../modules/views.md`](../modules/views.md), [`skins-system.md`](skins-system.md)

## The eleven rules

Numbered for cross-reference in PR comments. These rules were captured at the wiki bootstrap and have not been reconciled line-by-line with the canonical `PRINCIPLES.md` (added PR #565); treat them as a working summary until a full reconciliation is done.
