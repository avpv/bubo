...
public struct EvolutionHooks<C: Chromosome>: @unchecked Sendable {
    ...
    /// telemetry).
    public let onOffspringEvaluated: (@Sendable (_ generation: Int, _ offspring: [C], _ context: OptimizerContext) -> Void)?
    ...
    public let onGenerationComplete: (@Sendable (_ generation: Int, _ population: inout Population<C>, _ context: OptimizerContext) -> Void)?
    ...
    /// returning sort.
    public let onPostEvolution: (@Sendable (_ population: [C], _ context: OptimizerContext) -> Void)?
    ...
    public static var noop: EvolutionHooks<C> {
    ...
    /// about the other.
    public static func combine(_ a: EvolutionHooks<C>, _ b: EvolutionHooks<C>) -> EvolutionHooks<C> {
        EvolutionHooks(
