...
public struct FitnessPlateauDetector {
    ...
    public let relativeStddevThreshold: Double

    private var window: [Double] = []

    public init(capacity: Int, relativeStddevThreshold: Double = 1e-4) {
    ...
    /// generations.
    public mutating func push(_ fitness: Double) {
    ...
    public var filledCount: Int { window.count }
}
