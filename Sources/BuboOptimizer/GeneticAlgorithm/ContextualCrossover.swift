...
public final class GeneAttentionHead: @unchecked Sendable {
    ...
    public var currentWeights: [Double] {
    ...
    public func updateWeights(features: [Double], rewardSign: Double) {
        lock.lock()
        defer { lock.unlock() }
...
public enum ContextualCrossover {
