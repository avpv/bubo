...
public enum SymmetryBreaker {
    ...
    @discardableResult
    public static func canonicalize(_ chromosome: inout ScheduleChromosome) -> Bool {
    ...
    public static func canonicalized(_ chromosome: ScheduleChromosome) -> ScheduleChromosome {
        var copy = chromosome
        canonicalize(&copy)
        return copy
    }
    ...
    public static func canonicalizePopulation(_ population: inout [ScheduleChromosome]) {
...
public enum GeneEquivalenceClassifier {
