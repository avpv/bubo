...
public struct GAConfiguration: Sendable {
    ...
    public var crossoverStrategy: CrossoverStrategy
    public var convergenceThreshold: Double   // stop if fitness improvement < this for N generations
    public var convergencePatience: Int       // number of stale generations before stopping
    public var adaptiveMutation: Bool
    public var diversityThreshold: Double     // below this diversity, boost mutation & inject immigrants
    public var immigrationRate: Double        // fraction of population replaced by random immigrants on stagnation
    ...
    public var greedySeedFraction: Double
    ...
    public var adaptiveCrossover: Bool
    ...
    public var memeticHillClimbInterval: Int

    /// Number of individuals to hill-climb on each memetic pass.
    public var memeticHillClimbCandidates: Int
    ...
    public var memeticHillClimbSteps: Int
    ...
    /// meaningful renewal.
    public var chcRestartEliteFraction: Double
    ...
    public var chcRestartMutationRate: Double
    ...
    public var selfAdaptiveRates: Bool
    ...
    public static let `default` = GAConfiguration(
        populationSize: 100,
        maxGenerations: 200,
        mutationRate: 0.15,
        crossoverRate: 0.8,
    ...
    public static let quick = GAConfiguration(
        populationSize: 50,
        maxGenerations: 80,
        mutationRate: 0.2,
        crossoverRate: 0.8,
    ...
    public static let instant = GAConfiguration(
        populationSize: 20,
        maxGenerations: 20,
        mutationRate: 0.25,
        crossoverRate: 0.7,
    ...
    public static let polish = GAConfiguration(
        populationSize: 30,
        maxGenerations: 25,
        mutationRate: 0.08,
        crossoverRate: 0.75,
    ...
    public static let refine = GAConfiguration(
        populationSize: 60,
        maxGenerations: 80,
        mutationRate: 0.12,
        crossoverRate: 0.8,
    ...
    public static let thorough = GAConfiguration(
        populationSize: 200,
        maxGenerations: 500,
        mutationRate: 0.1,
        crossoverRate: 0.85,
