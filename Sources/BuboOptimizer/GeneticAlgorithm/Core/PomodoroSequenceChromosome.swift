...
public struct PomodoroSequenceChromosome: Chromosome, Sendable {
    ...
    public static func random(context: OptimizerContext) -> PomodoroSequenceChromosome {
    ...
    public func distance(to other: PomodoroSequenceChromosome) -> Double {
        let n = sequence.count
...
public struct PomodoroSequenceEvaluator {
    ...
    public func rankByParetoFronts(
...
public struct PomodoroSequenceResult: Sendable {
    ...
    public let alternatives: [[OptimizableEvent]]

    /// Per-objective scores for the best ordering.
    public let objectiveScores: (energy: Double, context: Double, deadline: Double, cognitive: Double)
}

/// Convenience wrapper that runs a GA to optimize task order within a Pomodoro session.
public struct PomodoroSequenceOptimizer {
    ...
    public static func optimizeWithAlternatives(
        tasks: [OptimizableEvent],
        sessionStart: Date,
        preferences: OptimizerPreferences = OptimizerPreferences(),
        config: GAConfiguration = .quick,
