...
public struct ScheduleConflictGraph: Sendable {
    ...
    public let componentOf: [String: Int]
    ...
    public let precedesBitsetHolder: ReachabilityBitsetHolder?
    ...
    public var precedesBitset: ReachabilityBitset? { precedesBitsetHolder?.value() }
    ...
    public var conflictDensity: Double {
    ...
    public var maxChainDepth: Double {
        let n = eventIds.count
    ...
    public static func build(from context: OptimizerContext) -> ScheduleConflictGraph {
    ...
    public static func build(fromMovableEvents events: [OptimizableEvent]) -> ScheduleConflictGraph {
    ...
    public func component(containing eventId: String) -> [String] {
    ...
    public func transitivelyPrecedes(_ prereq: String, _ dependent: String) -> Bool {
    ...
    public func precedenceTightness(
...
public final class ConflictGraphHolder: Sendable {
    private let state: OSAllocatedUnfairLock<ScheduleConflictGraph?>

    public init(preloaded: ScheduleConflictGraph? = nil) {
    ...
    public func get(for context: OptimizerContext) -> ScheduleConflictGraph {
