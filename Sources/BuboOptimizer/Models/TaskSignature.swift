...
public struct TaskSignature: Hashable, Sendable {
    public let eventIDsHash: Int
    public let totalDurationBucket: Int
    public let preferenceHash: Int

    public init(context: OptimizerContext) {
