...
public final class FitnessEvaluator: @unchecked Sendable {
    public var objectives: [any FitnessObjective]
    ...
    public let componentFitnessCache: ComponentFitnessCache?
    ...
    public let telemetry = FitnessEvalTelemetry()
    ...
    public static func standard(preferences: OptimizerPreferences) -> FitnessEvaluator {
        FitnessEvaluator(
            objectives: [
    ...
    public static let inclusionPenaltyExponent: Double = 2.0
    ...
    public func inclusionFactor(for chromosome: ScheduleChromosome) -> Double {
        var droppable = 0
        var included = 0
    ...
    public func evaluateAndAssign(_ chromosome: inout ScheduleChromosome, context: OptimizerContext) {
    ...
    public func evaluateIncremental(
        chromosome: ScheduleChromosome,
    ...
    public func objectiveBreakdown(
    ...
    public func updateWeights(from preferences: OptimizerPreferences) {
