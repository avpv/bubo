...
public struct ClusterAssignment: Sendable {
    ...
    public let clusterIndexOf: [String: Int]
    ...
    public func aggregate(objectives: [String: Double]) -> [Double] {
...
public final class ObjectiveCorrelationClusterer: @unchecked Sendable {
    ...
    public func observe(names: [String], rows: [[Double]]) {
    ...
    public func currentClustering() -> ClusterAssignment {
        lock.lock()
        defer { lock.unlock() }
    ...
    public static func pearsonMatrix(rows: [[Double]]) -> [[Double]] {
    ...
    public static func clusterByThreshold(
        names: [String],
        correlation: [[Double]],
        threshold: Double
    ) -> ClusterAssignment {
