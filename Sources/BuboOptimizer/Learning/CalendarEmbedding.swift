...
public struct CalendarEmbedding: Sendable, Equatable {
    ...
    public func similarity(to other: CalendarEmbedding) -> Double {
        var s = 0.0
    ...
    public func distance(to other: CalendarEmbedding) -> Double {
        var s = 0.0
...
public final class CalendarEmbedder: @unchecked Sendable {
    ...
    public func embed(chromosome: ScheduleChromosome, context: OptimizerContext) -> CalendarEmbedding {
    ...
    public func currentTripletLoss(
        anchor: ScheduleChromosome,
        positive: ScheduleChromosome,
        negative: ScheduleChromosome,
        context: OptimizerContext,
