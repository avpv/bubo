...
public struct BacklogTask: Identifiable, Codable, Hashable, Sendable {
    ...
    public var context: String?               // project / category
    ...
    public var dependsOn: [String] = []       // other task IDs
    public var preferredPeriod: Period?        // morning / afternoon / evening
    public var status: BacklogStatus = .pending
    ...
    public var recurrenceTag: String? = nil
    ...
    public var scheduledEventIds: [String] = []
    ...
    public var reminderCalendarItemId: String?
...
public enum BacklogStatus: String, Codable, Hashable, Sendable, CaseIterable {
