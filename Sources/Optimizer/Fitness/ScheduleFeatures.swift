...
public struct ScheduleFeatureVector: Sendable {
    ...
    /// rather than here.
    public var behavior: BehaviorDescriptor {
        BehaviorDescriptor(
            focusMass: values[0],
...
public extension ScheduleFeatureVector {
