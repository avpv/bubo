...
public struct PrecedenceObjective: ComponentPartitionedObjective {
    public let name = "Precedence"
    ...
    public let targetGapSeconds: TimeInterval

    public init(weight: Double = 0.5, targetGapSeconds: TimeInterval = 8 * 3600) {
        self.weight = weight
