...
public struct MeetingClusteringObjective: DayPartitionedObjective {
    public let name = "MeetingClustering"
    public var weight: Double

    /// Minimum gap between meetings to still count as same cluster (in seconds).
    public let clusterGapThreshold: TimeInterval

    public init(weight: Double = 0.8, clusterGapThresholdMinutes: Double = 15) {
        self.weight = weight
