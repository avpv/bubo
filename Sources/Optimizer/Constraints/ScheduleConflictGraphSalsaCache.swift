...
public struct ConflictEventMetadata: Sendable, Hashable {
    ...
    public let preferredHourLower: Int?
    public let preferredHourUpper: Int?
}
...
public struct ConflictOverlapDecision: Sendable, Hashable {
    ...
    public let hourRangesOverlap: Bool

    public var hasOverlap: Bool { shareParticipant || hourRangesOverlap }
}

public final class ScheduleConflictGraphSalsaCache: Sendable {
    ...
    public func graph(for context: OptimizerContext, rid: String? = nil) -> ScheduleConflictGraph {
    ...
    /// pipeline.
    public func graph(forMovableEvents events: [OptimizableEvent], rid: String? = nil) -> ScheduleConflictGraph {
    ...
    public var cachedEventMetadataCount: Int { eventMetadataDB.cachedCount }
    public var cachedPairCount: Int { pairOverlapDB.cachedCount }
    public var cachedReachabilityCount: Int { reachabilityDB.cachedCount }
